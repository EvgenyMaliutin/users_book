package com.example.users_book.controllers;

import com.example.users_book.dto.DtoMapper;
import com.example.users_book.dto.UserDTO;
import com.example.users_book.services.RegistrationService;
...
public class UserController {
    ...
    /**
     * Конструктор класса.
     * @param service сервис регистрации.
     * @param dtoMapper преобразование объектов.
     * @param validator валидатор объектов.
     */
